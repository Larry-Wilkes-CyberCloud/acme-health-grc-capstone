...
# GAP-07 (closed): least-privilege permissions scoped to exactly what
# the handler does (dynamodb:PutItem, s3:PutObject) plus KMS access
# for encrypted writes. HIPAA 164.312(a)(1).
